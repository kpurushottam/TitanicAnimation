...
public class TitanicImage {
    ...
    public void start(final TitanicImageView textView) {
        ...
        final Runnable animate = new Runnable() {
            ...
            public void run() {
                ...
                ObjectAnimator maskXAnimator = ObjectAnimator.ofFloat(textView, "width", 0, textView.getWidth());
        ...
        if (!textView.isSetUp()) {
            textView.setAnimationSetupCallback(new TitanicImageView.AnimationSetupCallback() {
                @Override
                public void onSetupAnimation(final TitanicImageView target) {
                    animate.run();
                }
            });
        } else {
